...
class AccountService:
    ...
    async def get_account(self, telegram_id: int) -> TelegramAccountOverview | None:
        ...
        async with self._vpn_access_uow:
            vpn_accesses = await self._vpn_access_uow.vpn_accesses.list_by_user_id(user.id)
